...
module.exports = {
	...
	getHistoricalDataForWeek: function(options) {
...
//		});
	...
	getPowerConsumedToday: function(options) {
		var self = this;
		return Q.promise(function(resolve, reject) {
			self.getHistoricalDataForWeek(options)
				.then(function(historicalDataForWeek) {
					var consumedToday = Number(historicalDataForWeek['value[6]']);
					resolve(consumedToday);
				})
				.fail(function(error) {
					reject(error);
				})
